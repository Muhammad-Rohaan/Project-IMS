...
router.delete(
  "/az-reception/delete-receptionist/:receptionRegId",
  removeReceptionist,
);
...
router.delete("/az-teachers/delete-student/:rollNo", deleteStudent);
...
router.get(
  "/az-teachers/fetch-teachers-by-class-and-subject/:class/:subject",
  searchTeacherByClassAndSubject,
); // GET /api/admin/az-teachers/fetch-teachers-by-class-and-subject/9/computer
